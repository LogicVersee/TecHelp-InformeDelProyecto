...
|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|
| **Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.**    | __Morales Quispe Brayan  Smith__ <br/>__TB1__<br/> * Lo aportado por mi fue el desarrollo de diagramas as-is y to-be<br/>__TB2__<br/>* Lo desarrollado por mi fue la correccion del informe y <br/> __Ramirez Mendez Sebastián André__ <br/>__TB1__<br/> Desarrollé el registro de entrevistas  que dio lugar a la formación del Needfinding <br/>__TB2__<br/> Realicé las correciones en los puntos de observación realizados en el capítulo 2<br/>__Lagos Aguilar Luis Eduardo__<br/>Se organizó reuniones de equipo para planificar las entregas y el diseño de la aplicación web. <br/>__TB2__<br/>Se diseñó la aplicación web, se implementó y se desplegó el Sprint 2 <br/> __Ramos Calderon Giovanni Andres__<br/>__TB1__<br/>* Se implementó una arquitectura con enfoque en los bounded context del negocio. <br/>__TP__<br/>* Se realizaron los componentes requeridos por las tareas del sprint Backlog<br/> __TB2__<br/>* Se implemento las entidades de tecnico, dashboard y componente del backend, siguiendo el diseño guiado por el dominio.<br/>__Saldaña Vela, Janover Gonzalo__ <br/>__TB1__<br/>* Mantuve una comunicación directa con todos los integrantes del grupo para delegar funciones y mantener inofrmado al equipo de trabajo sobre las responsabilidades y tareas que tenemos que realizar.<br/>__TB2__<br/>* Me comuniqué de forma constante con el euipo para generar un ambiente de trabajo ordenado manteniendo el nivel jerarquico de los roles dentro del equipo adoptadas por cada integrante al inicio del proyecto. |<br/>__TB1__<br/>Para la elaboracion de nuestro trabajo la comunicacion se dio por discord para compartir ideas,informacion e imagenes.Ademas de establecer tiempos de entregas fijos.<br/>__TB2__<br/> La comuniacion Oral se dio en el aula en los tiempos asignado por el profesor donde se coordino las partes a mejorar de la sigiente entrega  | 
| **Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.**   | Morales Quispe Brayan  Smith <br/>__TB1__<br/>* Buscamos comunicar de manera efectiva nuestras ideas y resultados de manera objetiva <br/>__TB2__<br/>* Buscamos adaptar nuestra comunicacion de nuestro proyecto  <br/> Ramirez Mendez Sebastián André <br/>__TB1__<br/>Se compartieron ideas para mejorar el enfoque del proyecto.<br/>__TB2__<br/>Se aplicaron mejoras para el entendimiento del documento.<br/>Lagos Aguilar Luis Eduardo<br/>__TB1__<br/>Nos comunicamos claramente con el equipo sobre los objetivos que deseamos alcanzar. <br/>__TB2__<br/>Se comunicó los errores que se tuvo en la entrega anterior y se corrigieron en su totalidad.<br/> Ramos Calderon Giovanni Andres<br/>__TB1__<br/>* Se corrigieron los puntos asignados por la retroalimentación<br/>__TP__<br/>* Se dió una comunicación efectiva para el cumplimiento de deberes <br/>__TB2__<br/>* Se desplegó nuestra primera vesión de nuestro API, así mismo se desplegó nuesta aplicación web con todos sus componentes. <br/> Saldaña Vela, Janover Gonzalo <br/>__TB1__<br/>* Comunicar nuestras ideas jugó un rol importante para identificar una problemática y plantear un salucion para ello.<br/>__TB2__<br/>* Durant e esta entrega la comunicación representó algo indispensable debido a que gracias a ello podimos culminar esta ultima entrega de forma exitosa.<br/>                                                                                                                                                                                                                                           | <br/>__TB1__<br/>Nuestras ideas fueron comunicadas a medias en esta primera entrega puesto que hubo una pequeña falta de comunicacion entre los integrantes del equipo.<br/>__TP__<br/>Hubo un mejoramiento enorme en la realizacion del trabajo puesto que se realizaron mejoras.Esto es debido al mejoramiento de la comunicacion entre en elquipo de trabajo y su organizacion que trajo consigo     | 
